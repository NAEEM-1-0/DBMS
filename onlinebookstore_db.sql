...
alter table Payment add foreign key (customerID) references Customers(customerID); 
 ...
 -- Admins
insert into Admins(adminID,firstName,lastName,emailID,password,phone) values('admin1','M J','Naeem','mjnaeem2004@gmail.com','abc123',1234567892);
insert into Admins(adminID,firstName,lastName,emailID,password,phone) values('admin2','M J','Naeem','mjnaeem2004@gmail.com','abc1',3454567892);
...
insert into Books(bookID,authorID,publisherID,title,genre,publicationYear,price) values(8,502,7001,'Fault in our Stars','Fiction',2012,687);
...
insert into Books(bookID,authorID,publisherID,title,genre,publicationYear,price) values(10,503,7001,'Ugly Love','Fiction',2014,350);
insert into Books(bookID,authorID,publisherID,title,genre,publicationYear,price) values(11,504,7000,'Pride & Prejudice','Fiction',1813,295);
