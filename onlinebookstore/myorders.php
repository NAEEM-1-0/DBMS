...
if ($accountType === 'admin') {
    $Data = $conn->query("SELECT o.orderID,o.customerID,o.bookID,o.quantity,o.total,o.timestamp,b.title FROM Orders o,Books b WHERE o.bookID=b.bookID ORDER BY orderID")->fetch_all(MYSQLI_NUM);
} else {
    $Data = $conn->query("SELECT o.bookID,o.quantity,o.total,o.timestamp,b.title FROM Orders o,Books b WHERE o.bookID=b.bookID AND o.customerID='$userID'")->fetch_all(MYSQLI_NUM);
}
...
<div id="wrapper" class="container">
    ...
    <section class="main-content"><div class="row"><div class="span12">
        ...
        <h4 class="title"><span class="pull-left"><span class="text"><span class="line"><strong>ALL ORDERS</strong></span></span></span></h4><br/>
        <table>
            <tr><th>Order ID</th><th>Customer ID</th><th>Book ISBN</th><th>Book Title</th><th>Quantity</th><th>Total</th><th>Timestamp</th></tr>
            <?php foreach ($Data as $order): ?>
            <tr><td><?= $order[0] ?></td><td><?= htmlspecialchars($order[1]) ?></td><td><?= $order[2] ?></td><td><?= htmlspecialchars($order[6]) ?></td><td><?= $order[3] ?></td><td><?= $order[4] ?></td><td><?= $order[5] ?></td></tr>
            <?php endforeach; ?>
        </table>
        <?php else: ?>
        <h4 class="title"><span class="pull-left"><span class="text"><span class="line"><strong>MY ORDERS</strong></span></span></span></h4><br/>
        <table>
            <tr><th>Book ISBN</th><th>Book Title</th><th>Quantity</th><th>Total</th><th>Timestamp</th></tr>
            <?php foreach ($Data as $order): ?>
            <tr><td><?= $order[0] ?></td><td><?= htmlspecialchars($order[4]) ?></td><td><?= $order[1] ?></td><td><?= $order[2] ?></td><td><?= $order[3] ?></td></tr>
            <?php endforeach; ?>
        </table>
        <?php endif; ?>
